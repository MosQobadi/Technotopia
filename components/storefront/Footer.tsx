...
export function Footer() {
  ...
  return (
    <footer className="bg-surface-sunken border-t border-line">
      <div className="mx-auto grid max-w-320 grid-cols-1 gap-10 px-6 py-16 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="max-w-70 text-sm leading-relaxed text-fg-subtle">{t("tagline")}</p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <Link href="#" className="text-sm text-fg-subtle">
              {t("returns")}
            </Link>
            <Link href="#" className="text-sm text-fg-subtle">
              {t("shippingInfo")}
            </Link>
            <Link href="mailto:support@technotopia.example" className="text-sm text-fg-subtle">
              support@technotopia.example
            </Link>
            <span className="text-[13px] text-fg-subtle" dir="ltr">
              +98 21 0000 0000
            </span>
          </div>
        </div>
      ...
      <div className="border-t border-line">
        <div className="mx-auto flex max-w-320 flex-wrap items-center justify-between gap-3 px-6 py-5">
          ...
          <div className="flex gap-5">
            <Link href="#" className="text-xs text-fg-muted">
              {t("privacy")}
            </Link>
            <Link href="#" className="text-xs text-fg-muted">
              {t("terms")}
