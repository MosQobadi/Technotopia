...
const SEARCH_SCOPES = ["All", "Products", "Categories", "Brands"] as const;
      ...
      <div className="mx-auto flex max-w-320 flex-wrap items-center gap-6 px-6 py-3.5">
        ...
        >
          ...
          <select
            ...
            className="h-10 shrink-0 rounded-full bg-transparent py-0 pr-1.5 pl-3.5 text-xs text-gray-500 outline-none"
          >
          ...
          <input
            ...
            placeholder="Search microphones, cameras, lights…"
        ...
        <div className="flex shrink-0 items-center gap-3.5">
          <Link href="/wishlist" aria-label="Wishlist" className={ICON_BUTTON_CLASSES}>
            <HeartIcon />
          </Link>

          <Link href="/cart" aria-label="Cart" className={`relative ${ICON_BUTTON_CLASSES}`}>
            <CartIcon />
            {itemCount > 0 && (
              <span className="bg-accent absolute -top-1 -right-1 flex size-4 items-center justify-center rounded-full text-[10px] font-bold text-white">
