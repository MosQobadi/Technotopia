...
// does nothing during SSR either way, because the inline script in the layout is
// what covers the first paint.
const useIsomorphicLayoutEffect = typeof window === "undefined" ? useEffect : useLayoutEffect;

export function ThemeGuard() {
  // No dependency array on purpose. There is nothing to depend on — the question
  // is only ever "is the attribute still there", and the render that follows a
  // reset is exactly when it needs asking.
