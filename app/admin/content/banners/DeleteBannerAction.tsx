...
interface DeleteBannerActionProps {
  bannerId: string;
  bannerHeadline: string;
  onDeleted: () => void;
}

export function DeleteBannerAction({
  bannerId,
  bannerHeadline,
  onDeleted,
}: DeleteBannerActionProps) {
      ...
      <AlertDialog.Backdrop>
        <AlertDialog.Container>
          <AlertDialog.Dialog>
            ...
            <AlertDialog.Header>
              <AlertDialog.Heading>Delete banner</AlertDialog.Heading>
            </AlertDialog.Header>
            <AlertDialog.Body>
              <p>
                Are you sure you want to delete <strong>{bannerHeadline}</strong>? This
                can&apos;t be undone.
              </p>
