...
export function DeleteBrandAction({ brandId, brandName, onDeleted }: DeleteBrandActionProps) {
      ...
      <AlertDialog.Backdrop>
        <AlertDialog.Container>
          <AlertDialog.Dialog>
            ...
            <AlertDialog.Body>
              <p>
                Are you sure you want to delete <strong>{brandName}</strong>? This can&apos;t be
                undone.
              </p>
