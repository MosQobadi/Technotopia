    ...
    <main className="mx-auto max-w-320 px-6 pt-10 pb-24">
      ...
      <div className="mb-18 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <div>
          ...
          <h1 className="mb-3.5 text-[32px] font-extrabold tracking-tight text-ink-900">
            {product.name}
          </h1>
          <PriceTag
            price={product.price}
          ...
          <div className="border-t border-gray-100 pt-6">
            <h2 className="mb-3 text-[17px] font-bold text-ink-900">Description</h2>
      ...
      {related.length > 0 && (
        <section>
          ...
          <h2 className="mb-6 text-[26px] font-extrabold tracking-tight text-ink-900">
